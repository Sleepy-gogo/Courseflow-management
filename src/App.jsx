...
function App() {
  ...
  return (
    <div
      className="bg-gradient-to-br from-cyan-400 to-blue-800 min-h-screen h-full p-3 md:p-10"
      style={{
    ...
    >
      ...
      <main
        className="flex flex-col-reverse gap-4 justify-end items-center lg:flex-row max-w-screen-xl mx-auto"
